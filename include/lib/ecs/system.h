 ...
 * - OnPreUpdate - все, что необходимо выполнить над сущностями прежде чем выполнить работу (например, очистить экран в
 * RenderingSystem)
 * - OnUpdate - непосредственно само обновление системы, происходит работа над значениями компонентов
 * - OnPostUpdate - после того, как мы выполнили работу, иногда нам необходимо сделать что-то после обновления (обновить
 * окно, например)
 */
class ISystem {
