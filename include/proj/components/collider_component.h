#ifndef INCLUDE_PROJ_COMPONENTS_COLLIDER_COMPONENT_H_
#define INCLUDE_PROJ_COMPONENTS_COLLIDER_COMPONENT_H_
...
#endif  // INCLUDE_PROJ_COMPONENTS_COLLIDER_COMPONENT_H_
